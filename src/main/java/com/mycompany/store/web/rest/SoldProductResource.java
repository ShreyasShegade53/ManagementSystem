...
import com.mycompany.store.domain.SoldProduct;
import com.mycompany.store.repository.SoldProductRepository;
...
/**
 * REST controller for managing {@link com.mycompany.store.domain.SoldProduct}.
 */
@RestController
@RequestMapping("/api")
@Transactional
