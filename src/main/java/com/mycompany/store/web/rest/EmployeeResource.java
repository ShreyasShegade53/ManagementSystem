...
import com.mycompany.store.domain.Employee;
import com.mycompany.store.repository.EmployeeRepository;
...
/**
 * REST controller for managing {@link com.mycompany.store.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
@Transactional
